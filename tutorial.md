...
NOTE: A visitors IP address can also be gotten on the server side, but there are issues where the returned IP address is of the server and not of the visitor.
