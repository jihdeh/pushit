...
Create a file called `config.js`. This is where we would add our pusher keys provided to us by Pusher. These can be found on your [dashboard](https://dashboard.pusher.com/).
